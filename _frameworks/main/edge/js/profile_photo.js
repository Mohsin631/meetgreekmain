var CProfilePhoto = function(guid,uid) {
    ...
    this.initUploadFile = function(type){
        ...
        $this.$ppUpload[type]['dropzone'].on('uploadprogress',function(file,progress){
            ...
            $(file.previewElement).find('.dz-desc').keydown(function(e){
                if(e.keyCode == 13){
...
//return;
    ...
    this.openGallery = function(e, pid, video, uid, cid, list, groupId) {
        list=list||false;
        groupId=groupId||0;
        cid *=1;
        if (!video) {
        ...
        if(dataMedia==undefined){//Fix - not data from gallery
            setTimeout(function(){$this.showGallery(pid, false, false, true, groupId)},100);
            return;
            ...
            setTimeout(function(){$this.showGallery(pid, false, list, false, groupId)},100);
        }
    }
    ...
    this.showGallery = function(pid, dataMedia, list, reloadData, groupId){
    ...
    $(function(){
        ...
        $win.on('popstate',function(){
            if (window.history && typeof history.state == 'object') {
                if ($jq('#events_notification').is('.pp_show')) {
