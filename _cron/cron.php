...
if ($min % 1 == 0) {
    ...
    if (DB::num_rows()) {
        ...
        if ($massmail['send_partner'] != 1) {
            ...
            if ($massmail['users'] == 1) {
                $where = 'use_as_online = 0 AND u.user_id != 0 AND u.lang IN (' . $massmail['languages'] . ') AND ';
            ...
            if ($massmail['users'] == 1 && $massmail['other'] == 1) {
                ...
                $where = '(u.user_id IS NULL OR (use_as_online = 0 AND u.lang IN (' . $massmail['languages'] . ') ' . $whereAddon . ' ) ) AND ';
            }
