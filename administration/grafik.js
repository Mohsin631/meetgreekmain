...
if(typeof infosoftglobal.Chameleon == "undefined") infosoftglobal.Chameleon = new Object();
infosoftglobal.FusionCharts = function(swf, id, w, h, debugMode, registerWithJS, c, scaleMode, lang, detectFlashVersion, autoInstallRedirect){
	...
	this.installedVer = infosoftglobal.Chameleon.getPlayerVersion();
...
infosoftglobal.FusionCharts.prototype = {
	...
	setDataURL: function(strDataURL){
		...
		if (this.initialDataSet==false){
			...
			var chartObj = infosoftglobal.Chameleon.getChartObject(this.getAttribute('id'));
...
/* ---- detection functions ---- */
infosoftglobal.Chameleon.getPlayerVersion = function(){
...
infosoftglobal.Chameleon.cleanupSWFs = function() {
...
if (infosoftglobal.FusionCharts.doPrepUnload) {
	if (!infosoftglobal.unloadSet) {
		infosoftglobal.Chameleon.prepUnload = function() {
			__flash_unloadHandler = function(){};
			__flash_savedUnloadHandler = function(){};
			window.attachEvent("onunload", infosoftglobal.Chameleon.cleanupSWFs);
		}
		window.attachEvent("onbeforeunload", infosoftglobal.Chameleon.prepUnload);
...
infosoftglobal.Chameleon.getChartObject = function(id)
{
  var chartRef=null;
...
infosoftglobal.Chameleon.updateChartXML = function(chartId, strXML){
	//Get reference to chart object				
	var chartObj = infosoftglobal.Chameleon.getChartObject(chartId);		
	//Set dataURL to null
...
var getChartFromId = infosoftglobal.Chameleon.getChartObject;
var updateChartXML = infosoftglobal.Chameleon.updateChartXML;
