...
class GroupsList extends Groups{
    ...
    static public function getTotalGroups($uid = null, $isPage = null) {
        if ($uid === null) {
            $uid = User::getParamUid(0);
        }
    ...
    static function getWhereList($table = '', $uid = 0, $isPage = null) {
        $guid = guid();
        $where = '';
    ...
    static public function getListGroups($limit = '', $typeOrder = '', $uid = null, $isPage = null) {
